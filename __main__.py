...
class Player:
    ...
    def check_active_challenges(self):
        ...
        return
    def __str__(self):
        return f"Ονοματεπωνυμο: {self.name}\t{self.surname}\t\t\t\tΗλικία:{self.age}\t\tΣύνολικά Games:{self.m_pl}"
            
    def __stats__(self):
        return f"{self.name} {self.surname}\t\t\tΣύνολικά Games:{self.m_pl}\t\tΝίκες:{self.m_won}\t Ηττες:{self.m_lost} \t\t Σύνολο σετ:{self.sets_pl}\t\t Κερδισμένα σετ:{self.sets_won}\t\t Χαμένα σετ:{self.sets_lost}"
...
class MAIN(tkinter.Tk):
    def __init__(self):
        ...
        self.label = tkinter.Label(text="Κατατάξη",bg='dark gray',fg = 'black')
        self.label.pack(anchor=tkinter.N,side=tkinter.TOP)
        self.text = tkinter.Text(bg='dark gray',fg = 'black',height=30,width = 160,relief=tkinter.RAISED)
        self.text.pack(anchor=tkinter.N,side=tkinter.TOP)
        self.label_right = tkinter.Label(text="Ενεργα Μάτς Πρόκλησης",bg='dark gray',fg = 'black')
        self.label_right.pack(anchor=tkinter.NE,side = tkinter.TOP)
        self.right_text = tkinter.Text(bg='dark gray',fg='black',height = 20,width = 80,relief=tkinter.RAISED)
        self.right_text.pack(anchor=tkinter.NE,side = tkinter.RIGHT)
        self.label_left = tkinter.Label(text="Εκρρεμή Μάτς Πρόκλησης",bg='dark gray',fg = 'black')
        self.label_left.pack(anchor=tkinter.NW,side = tkinter.TOP)
        self.left_text = tkinter.Text(bg = 'dark gray',fg = 'black',height = 20,width=80,relief=tkinter.RAISED)
...
class CONFIRMED(tkinter.Toplevel): 
    def __init__(self,parent): 
        ...
        tkinter.Label(self,bg="green",text="Αποδοχή",fg="white",padx=10,pady=10,font=("System",12)).pack()
...
class FAILED(tkinter.Toplevel): 
    def __init__(self,parent): 
        ...
        self.configure(background='silver')
        self.geometry(f"{self.screen_width//10}x{self.screen_height//10}+{self.screen_width//2}+{self.screen_height//2}")
        tkinter.Label(self,bg="red",text="Απόρριψη",fg="white",font=("System",12),padx=10,pady=10).pack(anchor=tkinter.CENTER)
...
class ADD_PLAYER(tkinter.Toplevel):
    def __init__(self,parent): 
        super().__init__(parent)
        self.title("Εγγραφή Νέου Παίχτη")
        self.screen_width = self.winfo_screenwidth()
        self.screen_height = self.winfo_screenheight()
        self.configure(background='silver')
        ...
        tkinter.Button(self,height=1,width=15,text = "Επιστροφή",activebackground="white",bg="silver",activeforeground="red",bd=8,relief=tkinter.RAISED,fg="black",font=("System",12),highlightcolor="black",command=self.destroy).pack(anchor=tkinter.SW,side=tkinter.LEFT)
        tkinter.Button(self,height=1,width=15,text = "Εγγραφή",activebackground="white",bg="silver",activeforeground="red",bd=8,relief=tkinter.RAISED,fg="black",font=("System",12),highlightcolor="black",command=self.confirm).pack(anchor=tkinter.SW,side=tkinter.RIGHT)
...
class DEL_PLAYER(tkinter.Toplevel):
    def __init__(self,parent): 
        ...
        tkinter.Button(self,height=1,width=15,bg="silver",text = "Επιστροφή",activebackground="white",activeforeground="red",bd=8,relief=tkinter.RAISED,fg="black",font=("System",12),highlightcolor="black",command=self.destroy).pack(anchor=tkinter.SW,side=tkinter.LEFT)
        tkinter.Button(self,height=1,width=15,bg="silver",text = "Διαγραφή",activebackground="white",activeforeground="red",bd=8,relief=tkinter.RAISED,fg="black",font=("System",12),highlightcolor="black",command=self.confirm_del).pack(anchor=tkinter.SW,side=tkinter.RIGHT)
...
class SETTINGS(tkinter.Toplevel):
    def __init__(self,parent):
        ...
        self.screen_height = self.winfo_screenheight()
        self.configure(background='silver')
        self.geometry(f"{self.screen_width//3}x{self.screen_height//4}+{self.screen_width//2}+{self.screen_height//2}")
        ...
        tkinter.Button(self,height=1,width=10,bg="silver",text = "Εγγραφή",activebackground="white",activeforeground="red",bd=8,relief=tkinter.RAISED,fg="black",font=("System",12),highlightcolor="black",command=self.define_settings).pack(anchor=tkinter.S,side=tkinter.BOTTOM)
### ΡΥΘΜΙΣΕΙΣ###
...
class NEW_CHALLENGE_MATCH(tkinter.Toplevel):
    def __init__(self,parent):
        super().__init__(parent)
        self.title("Δημιουργία Νέας Πρόκλησης")
        self.screen_width = self.winfo_screenwidth()
        self.screen_height = self.winfo_screenheight()
        self.configure(background='silver')
        self.geometry(f"{self.screen_width//6}x{self.screen_height//6}+{self.screen_width//2}+{self.screen_height//2}")
...
class BRIEF_CHALLENGE_MATCH(tkinter.Toplevel):
    def __init__(self,parent):
        super().__init__(parent)
        self.title("Ενημερώση Ενεργών Ματς")
        self.screen_width = self.winfo_screenwidth()
        self.screen_height = self.winfo_screenheight()
        self.configure(background='silver')
...
class OUTSTANDING_CHALLENGE_MATCH(tkinter.Toplevel):
    def __init__(self,parent):
        super().__init__(parent)
        self.title("Διαχείριση Εκρεμμών Ματς")
        self.screen_width = self.winfo_screenwidth()
        self.screen_height = self.winfo_screenheight()
        self.configure(background='silver')
        self.geometry(f"{self.screen_width//6}x{self.screen_height//6}+{self.screen_width//2}+{self.screen_height//2}")
        ...
        tkinter.Button(self,bg="silver",height=1,width=10,text = "Απόρριψη",activebackground="white",activeforeground="red",bd=8,relief=tkinter.RAISED,fg="black",font=("System",12),highlightcolor="black",command=self.deny_match).pack(anchor=tkinter.S,side=tkinter.BOTTOM)
